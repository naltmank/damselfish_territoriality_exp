...
(territory_plot <- ggplot(data = change, aes(x = Fertilized, y = Surface.area.pct.change) )+
  ...
  scale_x_discrete(limits = c('N', 'Y'), name = "Fertilizer treatment",
                   labels = c("N" = "Unfertilized", "Y" = "Fertilized")) + 
  scale_y_continuous(limits = c(-75, 60)) +
  theme_classic() + 
  labs(x ="Fertilized (Y/N)", y = "Percent change (area) \n", title = "(a)\n") +
...
(fish_plot <- ggplot(data = change, aes(x = Fertilized, y = Fish.pct.change) )+
  ...
  scale_x_discrete(limits = c('N', 'Y'), name = "Fertilizer treatment",
                   labels = c("N" = "Unfertilized", "Y" = "Fertilized")) + 
  theme_classic() + 
  labs(x ="Fertilized (Y/N)", y = "Percent change (resident fish)\n", title = "(b) \n") +
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.background = element_blank(),
        legend.position = "none",
...
behavior_means$Bite.rate.letter.height <- behavior_means$Bite.rate.per.m2 + behavior_means$Bite.rate.per.m2_se + 0.08
...
(bite_rate_graph <- ggplot()+
  ...
  geom_jitter(data = behavior, aes(x = Pre.post.trt, y = Bite.rate.per.m2, colour = Fertilized), alpha = 0.2,
              size = 4, width = 0.1) +
...
#            hjust = 0, size = 8) + 
  ...
  scale_colour_discrete(name = "Fertilizer treatment", labels = c("Unfertilized", "Fertilized") ) +
  scale_fill_discrete(name = "Fertilizer treatment", labels = c("Unfertilized", "Fertilized") ) +
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.background = element_blank(),
...
otherbites_means$Letter.height <- otherbites_means$Other.fish.bites.rate.per.m2 + otherbites_means$Other.fish.bites.rate.per.m2_se + 0.0005
```
...
(otherbite_rate_graph <- ggplot()+
  ...
  geom_errorbar(data = otherbites_means, aes(x = Pre.post.trt, ymin = Other.fish.bites.rate.per.m2 - Other.fish.bites.rate.per.m2_se,
             ...
             size = 0.6, position = position_dodge(width = 0.2), width = 0.15) +
  geom_jitter(data = otherbites, aes(x = Pre.post.trt, y = Other.fish.bites.rate.per.m2, colour = Fertilized), alpha = 0.2,
           size = 4, width = 0.1) +
...
behavior_means$Intra.chase.letter.height <- behavior_means$Intra.chase.rate.per.m2 + behavior_means$Intra.chase.rate.per.m2_se + 0.06
...
(intra_chase_rate_graph <- ggplot()+
  ...
  geom_errorbar(data = behavior_means, aes(x = Pre.post.trt, ymin = Intra.chase.rate.per.m2 - Intra.chase.rate.per.m2_se,
             ...
             size = 0.6, position = position_dodge(width = 0.2), width = 0.15) +
  geom_jitter(data = behavior, aes(x = Pre.post.trt, y = Intra.chase.rate.per.m2, colour = Fertilized), alpha = 0.2,
            size = 4, width = 0.1) +
...
(inter_chase_rate_graph <- ggplot()+
  ...
  geom_errorbar(data = behavior_means, aes(x = Pre.post.trt, ymin = Inter.chase.rate.per.m2 - Inter.chase.rate.per.m2_se,
             ...
             size = 0.6, position = position_dodge(width = 0.2), width = 0.15) +
  geom_jitter(data = behavior, aes(x = Pre.post.trt, y = Inter.chase.rate.per.m2, colour = Fertilized), alpha = 0.2,
           size = 4, width = 0.1) +
...
(bio_plot <- ggplot() + 
  ...
  labs(x ="Timepoint", 
       ...
       title= "(a) \n", color = "Fertilizer treatment", fill = "Fertilizer treatment") + # label axes
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.background = element_blank(),
        axis.line = element_line(colour = "black"),
    ...
    annotate("text", x = 0.5, y = 0.04, label = "Timepoint: P <0.001\nTreatment: P = 0.048\nTimepoint x Treatment: P = 0.16",
             hjust = 0, size = 8) +
